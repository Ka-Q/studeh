...
import { assertValidPageId, imagesDir } from './paths.ts';
import { InvalidDocumentIdError, InvalidImageUploadError } from './errors.ts';
import type { DocumentManifest, PageImage } from '../../shared/types.ts';
